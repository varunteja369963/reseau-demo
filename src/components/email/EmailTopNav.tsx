...
const notifications = [
  { id: 1, type: 'lead', icon: UserPlus, title: 'New subscriber', message: 'John Smith subscribed to your list', time: '2 min ago', read: false },
  { id: 2, type: 'message', icon: MessageSquare, title: 'Campaign sent', message: 'Welcome email delivered to 1,200 contacts', time: '15 min ago', read: false },
  { id: 3, type: 'alert', icon: AlertCircle, title: 'Bounce rate alert', message: 'High bounce rate detected in recent campaign', time: '1 hour ago', read: false },
  { id: 4, type: 'success', icon: CheckCircle, title: 'Automation completed', message: 'Onboarding sequence finished for 50 users', time: '3 hours ago', read: true },
  { id: 5, type: 'calendar', icon: Calendar, title: 'Scheduled campaign', message: 'Newsletter will be sent tomorrow at 9 AM', time: '5 hours ago', read: true },
];
            ...
            {tabs.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive && <span className="hidden md:inline">{tab.label}</span>}
                </button>
              );
            })}
          </div>
