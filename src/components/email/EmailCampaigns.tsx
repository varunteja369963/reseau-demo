  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="sent" className="space-y-5">
        <TabsList className="bg-muted/50 rounded-xl p-1 border border-border/50">
          <TabsTrigger 
            value="sent" 
            className="rounded-lg data-[state=active]:bg-background data-[state=active]:shadow-sm transition-all px-4"
          >
        ...
        <TabsContent value="sent" className="space-y-4">
          {campaigns.sent.map((campaign) => (
            <Card key={campaign.id} className="rounded-xl border border-border/50 hover:border-border transition-all group">
              <CardContent className="p-5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                  <div className="bg-muted/50 rounded-lg p-3">
                    ...
                    <div className="text-xl font-bold text-foreground">{campaign.delivered.toLocaleString()}</div>
                    <div className="text-xs text-muted-foreground mt-0.5">
                      {((campaign.delivered / campaign.recipients) * 100).toFixed(1)}% success
                    </div>
                  </div>
                  <div className="bg-muted/50 rounded-lg p-3">
                    <div className="text-xs text-muted-foreground font-medium flex items-center gap-1 mb-1">
                      <Eye className="w-3 h-3" />
                      Opens
                    </div>
                    <div className="text-xl font-bold text-foreground">{campaign.opened.toLocaleString()}</div>
                  ...
                  <div className="bg-muted/50 rounded-lg p-3">
                    ...
                    <div className="text-xl font-bold text-foreground">{campaign.clicked.toLocaleString()}</div>
                    <div className="flex items-center gap-1 text-xs text-muted-foreground mt-0.5">
                      <TrendingUp className="w-3 h-3" />
                      {campaign.clickRate}%
                    </div>
                  ...
                  <div className="bg-muted/50 rounded-lg p-3">
                    <div className="text-xs text-muted-foreground font-medium mb-1">Engagement</div>
                ...
                <div className="space-y-3 bg-muted/30 rounded-lg p-3">
                  ...
                  <div>
                    <div className="flex items-center justify-between text-xs mb-1.5">
                      ...
                      <span className="font-medium text-foreground">{campaign.clickRate}%</span>
                    </div>
                    <div className="h-1.5 bg-muted rounded-full overflow-hidden">
                      <div 
